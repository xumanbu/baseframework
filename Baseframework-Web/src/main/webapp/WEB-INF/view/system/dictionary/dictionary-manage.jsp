...
<div id="main">
	<div id="treeContent" class="left">
		<ul id="treeRoot" data-url= "${ctx}/dictionary/tree" root-id="0" root-name="数据字典" class="ztree"></ul>
	</div>
...
<%@ include file="/WEB-INF/includes/ztreelibs.jsp"%>
<script type="text/javascript" src="${ctx}/resources/js/dictionary/dictionary-manage.js"></script>
</html>
